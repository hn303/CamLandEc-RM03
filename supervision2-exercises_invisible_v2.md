...
5. In the interest of time, please download the `asc` files for other layers: [SLEUTH_asc_files.asc](https://github.com/hn303/CamLandEc-RM03/blob/master/data/five_asc_files.asc). Move `Road_2018.asc`, `Slope_2014.asc` and `Exclusion_2014.asc` to your QGIS working file.
